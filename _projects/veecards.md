...
With the other co-founders, I also worked on the backend, which was built in Java on top of "Google App Engine" and included a [CardDAV](https://en.wikipedia.org/wiki/CardDAV) server to share and update contacts.
